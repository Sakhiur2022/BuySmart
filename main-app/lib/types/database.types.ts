...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      feedback: {
        Row: {
          ai_category: Database['public']['Enums']['ai_feedback_category_enum'] | null;
      ...
      refunds: {
        Row: {
          ...
          ai_processed_at: string | null;
          ai_recommendation: Database['public']['Enums']['ai_refund_decision_enum'] | null;
